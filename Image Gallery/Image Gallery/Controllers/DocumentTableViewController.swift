...
class DocumentTableViewController: UITableViewController, cellTextDidUpdate, ImageGalleryDidAddImage, ImageGalleryDidDeleteImage {
    ...
    @IBAction func addButtonTapped(_ sender: UIBarButtonItem) {
        let imageGallery = ImageGallery(documentName: "Untitled".madeUnique(withRespectTo: currentDocumentNames))
...
extension DocumentTableViewController {
    ...
    func deleteModel(for imageModel: ImageModel, at modelIndex: Int, located galleryIndex: Int) {
        imageGalleries[galleryIndex].imageModels.remove(at: modelIndex)
    }
