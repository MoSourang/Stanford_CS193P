...
class CardView: UIView {
    ...
    var numberOfShape = Card.Number.featureOne { didSet { setNeedsDisplay() }}
    var typeOfShape = Card.Shape.featureOne  { didSet { setNeedsDisplay()}}
    var fillcolor = Card.Color.featureOne {didSet {setNeedsDisplay()}}
    var strokeColor = Card.Shadding.featureOne {didSet {setNeedsDisplay()}}
    ...
    func drawPathForCircles(numberOfPaths: Card.Number, with fillColor: UIColor?, and strokeColor: UIColor?) {
    ...
    func drawPathForSquares(numberOfPaths: Card.Number, with fillColor: UIColor?, and strokeColor: UIColor?) {
    ...
    func drawPathForTriangles(numberOfPaths: Card.Number, with fillColor: UIColor?, and strokeColor: UIColor?) {
    ...
    func calculateTriangleOrigine(numberOfPaths: Card.Number) -> [CGPoint]? {
    ...
    func calculateCircleCenter(numberOfPaths: Card.Number) -> [CGPoint]? {
    ...
    func calculateSquareOrigine(numberOfPaths: Card.Number) -> [CGPoint]? {
